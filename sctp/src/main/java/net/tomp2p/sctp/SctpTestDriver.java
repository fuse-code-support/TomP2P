...
public class SctpTestDriver {
	...
	public static void main(String[] args) {
		...
		InetSocketAddress local = InetSocketAddress.createUnresolved("192.168.1.210", 9989);
		InetSocketAddress remote = InetSocketAddress.createUnresolved("192.168.1.210", 9999);
