...
#define SCTP_CLASSNAME "net/tomp2p/sctp/Sctp"
...
/*
 * Class:     net_tomp2p_sctp_Sctp
 * Method:    on_network_in
 * Signature: (J[BII)V
 */
JNIEXPORT void JNICALL
Java_net_tomp2p_sctp_Sctp_on_1network_1in
...
Java_net_tomp2p_sctp_Sctp_usrsctp_1accept
 ...
 */
JNIEXPORT void JNICALL
Java_net_tomp2p_sctp_Sctp_usrsctp_1close
    (JNIEnv *env, jclass clazz, jlong ptr)
{
    SctpSocket *sctpSocket;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_net_tomp2p_sctp_Sctp_usrsctp_1connect
 ...
 */
JNIEXPORT jboolean JNICALL
Java_net_tomp2p_sctp_Sctp_usrsctp_1finish
 ...
 */
JNIEXPORT jboolean JNICALL
Java_net_tomp2p_sctp_Sctp_usrsctp_1init
    (JNIEnv *env, jclass clazz, jint port)
{
     ...
     * AF_CONN use of SCTP.
     */
    debugSctpPrintf("=====>: net_tomp2p_sctp_Sctp.c calling init\n");
    usrsctp_init((uint16_t) port, onSctpOutboundPacket, debugSctpPrintf);

    debugSctpPrintf("=====>: net_tomp2p_sctp_Sctp.c about to set SCTP_DEBUG_ALL\n");
#ifdef SCTP_DEBUG
    debugSctpPrintf("=====>: net_tomp2p_sctp_Sctp.c setting SCTP_DEBUG_ALL\n");
 ...
 */
JNIEXPORT void JNICALL
Java_net_tomp2p_sctp_Sctp_usrsctp_1listen
    (JNIEnv *env, jclass clazz, jlong ptr)
{
    SctpSocket *sctpSocket;
...
Java_net_tomp2p_sctp_Sctp_usrsctp_1send
...
Java_net_tomp2p_sctp_Sctp_usrsctp_1socket
